    ...
    return (
        <>
            ...
            <section>
                ...
                {/* MOBILE */}
                <div className='flex flex-col items-center gap-1 min-h-screen px-5 m-14 md:hidden'>
                    <div className='flex h-alturaGaleriaDivs w-larguraGaleriaDivs gap-1'>
                    ...
                    <div className='bg-galeria3 bg-no-repeat bg-center bg-cover h-G3-A w-larguraGaleriaDivs'></div>
                    <div className='bg-galeria4 bg-no-repeat bg-center bg-cover h-G4-A w-larguraGaleriaDivs'></div>

                    <div className='flex h-127 w-larguraGaleriaDivs gap-1'>
                    ...
                    <div className='bg-galeria7 bg-no-repeat bg-center bg-cover w-larguraGaleriaDivs h-G4-A'></div>
